        ...
        <div className="bg-gray-100">
            <div className="container mx-auto p-4">
                <div className="bg-white rounded-lg shadow-md p-8 max-w-md mx-auto">
                    <h1 className="text-3xl font-semibold mb-6 text-center">Sửa sản phẩm</h1>
                    <form>
                        <div className="mb-4">
                        ...
                        <button type="submit" className="bg-purple-500 text-white font-semibold px-6 py-3 rounded-lg w-full hover:bg-purple-600">Cập nhật sản phẩm</button>
                    </form>
                </div>
            </div>
        </div>
